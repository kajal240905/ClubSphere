...
export default function ViewUserProfile() {
  ...
  return (
    <div className="bg-blue-200 relative text-black w-full min-h-screen overflow-hidden flex justify-center items-center px-4 py-8">
      ...
      <div className="bg-white w-full max-w-lg rounded-xl shadow-2xl hover:scale-105 transition-transform duration-300 text-xl text-center p-6">
        <img className="mx-auto w-[140px] h-[140px] mb-4" src={profile} alt="Profile" />
