...
export default function AdminPower(){
 ...
 w-[40vw] h-[10vh] text-center text-xl pt-5 rounded-xl md:mt-0 mt-12  md:mr-8 space-x-8" onClick={()=>navigate('/addEvent')}>Add an event</div>
        <div data-aos="fade-right" className="bg-zinc-900 md:ml-0 ml-7 shadow-[0_0_12px_#B026FF] hover:bg-[#B026FF] hover:text-black hover:scale-105 w-[40vw] h-[10vh] text-center text-xl pt-5 rounded-xl mt-12 md:mt-0 md:mr-8" onClick={()=>navigate('/addAnnounce')}>Announce</div>
