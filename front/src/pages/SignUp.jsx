  ...
  return (
    <div className="flex relative h-screen w-full justify-center items-center bg-black">
      ...
      <div
        ...
        className="absolute md:h-[95vh] my-4 py-4 md:w-1/4 bg-black border-0.2 border-amber-200 shadow-2xl flex flex-col justify-center items-center w-[80vw] h-[75vh]"
      >
        <h1
